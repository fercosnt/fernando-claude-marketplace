...
> **Use a skill `project-instructions`.** Instrucao de projeto (Chat Project e Cowork) tem skill dedicada, com roteamento de camadas, orcamento de caracteres, modo auditoria e montagem do pacote do projeto. O template abaixo ficou aqui so como referencia historica — ele e longo demais para a orientacao oficial da Anthropic, que pede instrucoes concisas porque elas consomem janela de contexto. Nao use como ponto de partida.

### Template antigo (nao usar — ver `project-instructions`)
