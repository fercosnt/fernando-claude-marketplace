# Nano Banana Pro - Prompts Cinematograficos

Templates de prompt por tipo de evento e categorias cinematograficas para geracao de imagens.

---

## Indice

1. [Template Master - Categorias Cinematograficas](#template-master---categorias-cinematograficas)
2. [Templates por Tipo de Evento](#templates-por-tipo-de-evento)
3. [Aspect Ratio por Uso](#aspect-ratio-por-uso)
4. [Dicas por Marca](#dicas-por-marca)
...
- Pedir "photorealistic photograph" (nunca "render" ou "3D") — termos como "render" ativam estilos de computacao grafica em vez de fotorrealismo
- Descrever cena narrativamente, nao listar keywords soltas — descricoes narrativas produzem composicoes mais coerentes
- Quanto mais especifico, melhor o resultado — detalhes como angulo de camera, lente e temperatura de cor reduzem ambiguidade
