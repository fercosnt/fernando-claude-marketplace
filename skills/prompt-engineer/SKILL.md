...
- Exemplos anotados (mostrar POR QUE e bom, nao so o resultado)
...
**Regra critica:** Pensamento DEVE ser externalizado. Sem output de thinking = sem raciocinio.

### 4. Few-Shot Examples (2-5)
Requisitos: Relevantes, Diversos, Anotados. Usar `<example>` tags. Incluir "Por que e bom".

### 5. Role Prompting
Mais especifico = melhor. "Cientista de dados senior em empresa Fortune 500 especializado em churn prediction" >> "Cientista de dados".
...
6. **Pedir pensamento interno sem output** — Sem externalizacao = sem raciocinio
...
| Prefilling | Suportado (exceto Opus 4.7) | Nao suportado | Nao suportado | Nao suportado | Nao disponivel | Nao disponivel |
| Adaptive Thinking | Opus 4.7 (unico modo) / Sonnet 4.6 (opcional) | o1/o3/o4-mini (reasoning) | Flash Thinking | Nao disponivel | Nao disponivel | Nao disponivel |
| Few-Shot | 2-5 exemplos | 3-7 exemplos | 2-4 exemplos | 1-3 exemplos | 1-2 (contexto limitado) | 1-2 (contexto limitado) |
| Context Window | 1M (Opus 4.7) / 200K-1M (Sonnet 4.6) | 128K | 1M+ | 8K-128K | Limitado (varia) | Limitado (varia) |
...
| Sampling params | `temperature`/`top_p` rejeitados no Opus 4.7 | Ajustavel | Ajustavel | Ajustavel | N/A | N/A |
