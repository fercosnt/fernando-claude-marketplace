...
(abertas, atrasadas, foco da semana, em aprovação com horas, em refação com `Refações`, travadas com "motivo escrito: sim/não",
...
(≤3) · 📅 Vence nesta semana (≤2 linhas por pessoa) · ✋ Aprovação parada · 🔁 Em refação (onde se concentra, por tipo de entrega/empresa — nunca por pessoa) · ⚖️ Carga (só quem está
...
escrito · `Refações` nunca somado nem comparado por pessoa (sem motivo, mistura ajuste clínico com erro) · padrão só com contagem (senão "impressão") · português do time.
