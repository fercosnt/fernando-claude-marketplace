...
| [conta-azul](./conta-azul/) | ERP Conta Azul via MCP local — 38 tools (resumo financeiro, receber/pagar, saldos, vendas, NF), escrita opcional com previa antes de enviar. Credenciais em `~/.conta-azul-mcp.json` | 3 | 0.1.0 |
